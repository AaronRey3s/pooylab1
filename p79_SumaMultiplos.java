...
public class p79_SumaMultiplos {
    ...
    public static void main(String[] args) {
        Scanner wolves = new Scanner(System.in);
        System.out.print("\033[H\033[2J");
        System.out.println("Suma de los múltiplos de 3 o 4 en un rango dado ");
        System.out.println("\nPor favor ingresa el inicio "); int ini = wolves.nextInt();
        System.out.println("\nPor favor ingresa el fin "); int fin = wolves.nextInt();
        if (ini >= fin) {
            ...
            System.out.print("Elije ? "); int op = wolves.nextInt();
            switch (op) {
                case 1:
