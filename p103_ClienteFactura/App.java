...
public class App {
    public static Factura Llenar() {
        ...
        System.out.print("Id Factura     : "); f.setId(Aaron.nextInt());
        System.out.print("Monto          : "); f.setMonto(Aaron.nextDouble());
        System.out.print("Cliente Id     : "); c.setId(Aaron.nextInt()); Aaron.nextLine();
        System.out.print("Cliente Nombre : "); c.setNombre(Aaron.nextLine()); 
        System.out.print("Cliente Desc   : "); c.setDescuento(Aaron.nextFloat());
        f.setCliente(c);
        return f;
    }
